...
<!-----------Fin MenuR-->
 ...
 <div class="slideshow-container"><!--Contenedor imagenes-->
    ...
    <main class="main">
      <section class="group catalogo"><!-- Importante para centrar elementos-->
      <?php include("../Componentes/CProducto.php");?>
        </section>  
         <!--Boton-->
 <div class="boton-modalSGR">
        <label for="btn-modalSGR" class="conteniu">
...
<div class="container-modalSGR">
    ...
    <div class="btn-cerrarSGR contCerrar"> <label for="btn-modalSGR" class="iconoXMensaje">X</label></div> <!--Botón Cerrar-->
        ...
        <div class="formlgroup">
            ...
            <label for="Question" class="form_label1 form__comente" placeholder="">Escribe tu duda:</label>
            </div>
     ...
     <label for="btn-modalSGR" class="cerrar-modalSGR"></label><!--Sale al presionar fuera del formulario-->
</div>
    <?php  
